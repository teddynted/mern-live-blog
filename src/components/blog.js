...
class Blog extends Component {
    constructor(props){
      super(props);
      this.socket = io('http://localhost:1993', { transports: [ 'websocket', 'polling', 'flashsocket' ] });
                ...
                <div className="col-lg-12 col-md-12">
                   ...
                   <form onSubmit={this.onSubmit.bind(this)}>
                     <div className="form-group">
                       <textarea name="blog-post" type="blog-post" onChange={this.handleChange.bind(this)} className="form-control" id="blog-post" placeholder="Blog post"></textarea>
                     </div>
